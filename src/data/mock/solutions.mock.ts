...
const DEFS: Def[] = [
  {
    slug: 'indoor-led-display', name: 'Màn hình LED trong nhà', icon: 'Monitor',
    ...
    features: [
      { title: 'Pixel pitch mịn', description: 'Đa dạng từ P1.25 đến P2.5 phù hợp khoảng cách xem gần.', icon: 'Grid3x3' },
      { title: 'Calibration tự động', description: 'Hiệu chỉnh màu và độ sáng đồng nhất toàn màn hình.', icon: 'SlidersHorizontal' },
      { title: 'Bảo trì mặt trước', description: 'Thay thế module nhanh chóng, tiết kiệm không gian.', icon: 'Wrench' },
    ],
  ...
  {
    slug: 'outdoor-led-display', name: 'Màn hình LED ngoài trời', icon: 'Sun',
    ...
    features: [
      { title: 'Chống nước IP65', description: 'Hoạt động bền bỉ dưới mưa nắng khắc nghiệt.', icon: 'CloudRain' },
      { title: 'Độ sáng cao', description: 'Hiển thị rõ nét ngay cả dưới ánh nắng trực tiếp.', icon: 'Sun' },
      { title: 'Cảm biến độ sáng', description: 'Tự động điều chỉnh theo môi trường, tiết kiệm điện.', icon: 'Gauge' },
    ],
  ...
  {
    slug: 'control-room-led', name: 'Màn hình LED phòng điều hành', icon: 'LayoutDashboard',
    ...
    features: [
      { title: 'Đa cửa sổ', description: 'Hiển thị nhiều nguồn tín hiệu cùng lúc, tùy biến layout.', icon: 'LayoutGrid' },
      { title: 'Failover kép', description: 'Nguồn và card nhận dự phòng đảm bảo không gián đoạn.', icon: 'ShieldCheck' },
  ...
  {
    slug: 'smart-meeting-room', name: 'Phòng họp thông minh', icon: 'Presentation',
    ...
    features: [
      { title: 'Camera hội nghị', description: 'Khung hình tự động bám người nói.', icon: 'Video' },
      { title: 'Trình chiếu không dây', description: 'Chia sẻ nội dung từ mọi thiết bị.', icon: 'Cast' },
      { title: 'Màn hình tương tác', description: 'Ghi chú, vẽ và cộng tác trực tiếp.', icon: 'PenTool' },
    ],
  ...
  {
    slug: 'smart-classroom', name: 'Lớp học thông minh', icon: 'GraduationCap',
    ...
    features: [
      ...
      { title: 'Phần mềm giảng dạy', description: 'Soạn và trình bày bài giảng tương tác.', icon: 'BookOpen' },
      { title: 'Âm thanh lớp học', description: 'Giọng nói rõ ràng tới mọi vị trí.', icon: 'Volume2' },
    ],
  ...
  {
    slug: 'smart-hospital', name: 'Bệnh viện thông minh', icon: 'HeartPulse',
    ...
    features: [
      { title: 'Hệ thống gọi y tá', description: 'Liên lạc tức thời giữa bệnh nhân và điều dưỡng.', icon: 'BellRing' },
      { title: 'Kiosk & xếp hàng', description: 'Lấy số tự động, hiển thị thứ tự thông minh.', icon: 'Ticket' },
  ...
  {
    slug: 'smart-city', name: 'Đô thị thông minh', icon: 'Building2',
    ...
    features: [
      { title: 'Camera AI', description: 'Nhận diện biển số, đám đông, sự cố giao thông.', icon: 'Cctv' },
      { title: 'Nền tảng IoT', description: 'Thu thập dữ liệu cảm biến môi trường, năng lượng.', icon: 'Radio' },
      { title: 'Trung tâm IOC', description: 'Bảng điều khiển điều hành đô thị tập trung.', icon: 'LayoutDashboard' },
    ],
  ...
  {
    slug: 'ai-camera', name: 'Camera AI', icon: 'Cctv',
    ...
    features: [
      ...
      { title: 'Nhận diện đối tượng', description: 'Người, phương tiện, biển số, sự kiện bất thường.', icon: 'ScanFace' },
      { title: 'Báo cáo thông minh', description: 'Thống kê, heatmap và cảnh báo tự động.', icon: 'BarChart3' },
    ],
  ...
  {
    slug: 'iot-platform', name: 'Nền tảng IoT', icon: 'Radio',
    ...
    features: [
      { title: 'Đa giao thức', description: 'MQTT, LoRaWAN, Modbus, BACnet.', icon: 'Network' },
      { title: 'Dashboard thời gian thực', description: 'Trực quan hóa dữ liệu cảm biến tức thì.', icon: 'Activity' },
      { title: 'Quy tắc tự động', description: 'Thiết lập kịch bản điều khiển thông minh.', icon: 'Workflow' },
    ],
  ...
  {
    slug: 'digital-signage', name: 'Digital Signage', icon: 'MonitorPlay',
    ...
    features: [
      ...
      { title: 'Lên lịch phát', description: 'Tự động phát nội dung theo khung giờ.', icon: 'CalendarClock' },
      { title: 'Đa nền tảng', description: 'Màn hình LCD, LED, chân đứng quảng cáo.', icon: 'MonitorSmartphone' },
    ],
