  ...
  return (
    <section className="relative overflow-hidden pb-12 pt-32">
      ...
      <Container className="relative">
        ...
        <h1 className="mt-5 max-w-4xl text-balance pb-1 text-4xl font-bold leading-[1.25] md:text-5xl">{title}</h1>
        {description && <p className="mt-5 max-w-4xl text-lg leading-relaxed text-muted">{description}</p>}
        {children}
      </Container>
    </section>
  );
